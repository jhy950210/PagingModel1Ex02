		...
		<div class="board_top">
			...
			<div align="right">
				<form action="" method="post" name="">
					아이디 <input type="text" name="writer" value="" class="board_view_input_mail" maxlength="5" />
					비밀번호 <input type="password" name="password" value="" class="board_view_input_mail"/>
					<input type="button" value="로그인" class="btn_write btn_txt01" style="cursor: pointer;" />
				</form>
			</div>
		</div>
